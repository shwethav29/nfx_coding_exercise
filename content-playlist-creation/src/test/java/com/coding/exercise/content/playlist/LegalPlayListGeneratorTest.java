...
public class LegalPlayListGeneratorTest {
	...
	public void testLegalPlayListOnePlaylist() {
		StringReader reader = new StringReader("{\n" + 
				...
				LegalPlayListPlayer legalPlayListsForUS = new LegalPlayListGeneratorImpl().getLegalPlaylists(playListData, "MI3", "US");
				assertTrue("[{V4,V1},{V6,V3}]".equals(legalPlayListsForUS.toString()));
				LegalPlayListPlayer legalPlayListsForCA = new LegalPlayListGeneratorImpl().getLegalPlaylists(playListData, "MI3", "CA");
				...
				try {
					...
					assertTrue("No legal playlist possible because the Pre-Roll Video isn't compatible with language of Content Video for the UK".equals(e.getMessage()));
				}
	...
	public void testNoLegalPlayListMissingPreroll() {
		...
		try {
			...
			assertTrue("No legal playlist possible because the Pre-Roll Video isn't compatible with language of Content Video for the US".equals(e.getMessage()));
		}
	...
	public void testLegalPlayListNoPrerollWB2matchforCA() {
		...
		try {
			...
			assertTrue("No legal playlist possible because the Pre-Roll Video isn't compatible with language of Content Video for the CA".equals(e.getMessage()));
		}
